...
public class ExampleApp {
    ...
    public static void main(String[] args)  {
        ...
        System.out.println(food.getProduct("Crackers").getName() + " cal: " + food.getProduct("Crackers").getCalories());
        
        
        Recipe r = new Recipe("Pasta and Nutella", food);
        r.addIngredient("Pasta", 70);
        r.addIngredient("Nutella", 25);
        
        for(NutritionalElement e : food.recipes()){
